            ...
            return (
              <div key={item.id} className={styles.discounts__container}>
                ...
                <div className={styles.discounts__airpods3__wrap}>
                  <Image className={styles.discounts__airpods3__img} src='/assets/imgs/backgroundSales3.png' alt='airpods 3' layout="fill"></Image>
                </div>
                </div>
                <div className={styles.discounts__airpodsPro__underwrap}>
                <div className={styles.discounts__airpodsPro__wrap}>
                  <Image className={styles.discounts__airpodsPro__img} src='/assets/imgs/backgroundSalesPro.png' alt='airpods pro' layout="fill"></Image>
                </div>
                </div>
                <div className={styles.discounts__watches__underwrap}>
                <div className={styles.discounts__watches__wrap}>
                  <Image className={styles.discounts__watches__img} src='/assets/imgs/backgrounWatches(1).png' alt='watches' layout="fill"></Image>
                </div>
                </div>
                <div className={styles.discounts__content}>
                  <h3 className={styles.discounts__content__date}>До {item.date}</h3>
